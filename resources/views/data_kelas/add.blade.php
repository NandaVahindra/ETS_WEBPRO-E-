...
<div class="col-12 grid-margin stretch-card">
    <div class="card">
        <div class="card-body">
            <h4 class="card-title mb-4">Tambah Mahasiswa di Kelas</h4>
            @if ($errors->any())
            ...
            @endif
            <form class="forms-sample" method="POST" action="/classaddmhs" enctype="multipart/form-data">
                @csrf

                <div class="form-group">
                    <label for="NRP">NRP</label>
                    <input type="number" class="form-control" id="NRP" placeholder="8 digit, ex : 10011002"
                        name="NRP" required>
                </div>
                ...
                <input type="hidden" name="id" value="{{ $data->id }}">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" id="jurusan" name="tahunAjaran"
                            value="{{ $data->tahunAjaran }}" readonly>
                    </div>
